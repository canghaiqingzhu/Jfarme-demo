...
//---管理-----------------------------------------------
		...
		if(root == 1){
			...
			btnboss.setBounds(236, 88, 139, 23);
			jp1.add(btnboss);
		}			
			JButton btnNewButton = new JButton("商品信息录入");
			btnNewButton.addActionListener(this);
			btnNewButton.setBounds(236, 55, 139, 23);
...
//----工作------------------------------------------------------------------------------------
		...
		label1.setBounds(166, 23, 66, 15);
		jp2.add(label1);

		thingNum = new JTextField();
		thingNum.setBounds(219, 20, 66, 21);
		jp2.add(thingNum);
...
//如何清添加的记录？？	
		...
		}else if("商品信息录入".equals(e.getActionCommand())){
			this.setVisible(false);
